    ...
    <div className="min-h-screen flex bg-base-200 relative">
      ...
      >
        <div className="flex flex-col space-y-4">
          ...
          <a className="btn btn-primary btn-block rounded-lg hover:bg-white hover:text-primary hover:shadow-xl">
            Dashboard
          </a>
            ...
            <table className="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div className="badge badge-success text-slate-50 px-4">Verify</div>
                  </td>
                  <th>
                ...
                <tr>
                  ...
                  <td>
                  <div className="badge badge-error text-slate-900">Rejected</div>
                  </td>
                  <th>
                    <button className="btn btn-ghost btn-xs">details</button>
                  </th>
                ...
                <tr>
                  ...
                  <td>
                  <div className="badge badge-warning text-slate-950">Pending</div>
                  </td>
                  <th>
                    <button className="btn btn-ghost btn-xs">details</button>
                  </th>
