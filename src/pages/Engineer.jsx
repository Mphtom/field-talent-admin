...
const Engineer = () => {
  const client = {
    ...
    militaryServiceImage: "https://www.atd13.fr/wp-content/uploads/2021/04/AdobeStock_248823389-web-1536x1024.jpeg",
    graduationCertificateImage: "https://www.atd13.fr/wp-content/uploads/2021/04/AdobeStock_248823389-web-1536x1024.jpeg",
    syndicateImage: "https://www.atd13.fr/wp-content/uploads/2021/04/AdobeStock_248823389-web-1536x1024.jpeg",
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-base-100 flex items-center justify-center p-6">
      ...
      >
        <div className="bg-primary text-primary-content px-10 py-8">
          <h1 className="text-5xl font-bold mb-2">Engineer Details</h1>
        </div>
        ...
        <div className="w-full p-8">
          <h2 className="text-2xl font-semibold mb-4 text-primary">Third Document</h2>
          <div className="flex justify-between">
            <div className="flex-1 mx-2">
              <p className="text-sm text-base-content mb-2">Military</p>
              <img 
                src={client.militaryServiceImage} 
                alt="Military Service" 
                className="w-full h-48 object-cover rounded-lg shadow-md cursor-pointer transition-transform hover:scale-105"
                onClick={() => openModal(client.militaryServiceImage)}
              />
            </div>
            <div className="flex-1 mx-2">
              <p className="text-sm text-base-content mb-2">Graduation</p>
              <img 
                src={client.graduationCertificateImage} 
                alt="Graduation Certificate" 
                className="w-full h-48 object-cover rounded-lg shadow-md cursor-pointer transition-transform hover:scale-105"
                onClick={() => openModal(client.graduationCertificateImage)}
              />
            </div>
            <div className="flex-1 mx-2">
              <p className="text-sm text-base-content mb-2">Syndicate</p>
              <img 
                src={client.syndicateImage} 
                alt="Syndicate Document" 
                className="w-full h-48 object-cover rounded-lg shadow-md cursor-pointer transition-transform hover:scale-105"
                onClick={() => openModal(client.syndicateImage)}
              />
            </div>
          </div>
        </div>
